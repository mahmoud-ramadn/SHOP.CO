  ...
  <div class="container mx-auto">
    <div class="flex flex-col items-center my-8 space-y-5">
      ...
      >
        ...
        >
          <div
            class="w-full overflow-hidden bg-card shadow-md xl:h-[400px] md:h-[250px] h-[200px] p-6 rounded-md flex justify-center items-center"
          >
            <img
              class="md:w-[295px] w-[198px] md:h-[298px] h-[200px] object-contain opacity-90 mix-blend-multiply"
              :src="product.image"
              alt="image"
            />
          </div>
